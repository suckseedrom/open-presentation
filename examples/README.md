...
The examples now assume a zero-dependency HTML composition by default. Use the preview cards in `reference/STYLE_INDEX.md` and `templates/*/preview.md` when you need help choosing a look.
