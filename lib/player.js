 ...
 *
 * Usage:
 *   new PresentationPlayer(container, { scenes, durations, audioUrl, theme, onExit, onDownload })
 */
...
class PresentationPlayer {
  ...
  constructor(container, opts = {}) {
    ...
    this._onDownload = typeof opts.onDownload === 'function' ? opts.onDownload : null;
  ...
  _buildTransport() {
    ...
    if (this._onDownload) {
      pill.appendChild(makeBtn('Download to Video (4K)', ICONS.download, 'pf-btn pf-btn--download', () => this._onDownload()));
    }
